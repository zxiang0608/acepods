  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto w-full max-w-[820px] px-5 pb-16 pt-10 md:px-8 md:pt-12">
        ...
        <h1 className="text-[34px] font-bold leading-[1.1] tracking-tight text-[#14181c] md:text-[44px]">Terms of Use</h1>
        ...
        <div className="mt-8 space-y-8 text-[16px] leading-[1.7] text-[#30363d]">
          ...
          <section>
            <h2 className="mb-3 text-[22px] font-semibold tracking-tight text-[#14181c]">1. Acceptance of terms</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[22px] font-semibold tracking-tight text-[#14181c]">2. Use of this website</h2>
          ...
          <section>
            <h2 className="mb-3 text-[22px] font-semibold tracking-tight text-[#14181c]">3. Product and pricing information</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[22px] font-semibold tracking-tight text-[#14181c]">4. No contractual offer</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[22px] font-semibold tracking-tight text-[#14181c]">5. Intellectual property</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[22px] font-semibold tracking-tight text-[#14181c]">6. Third-party links</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[22px] font-semibold tracking-tight text-[#14181c]">7. Limitation of liability</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[22px] font-semibold tracking-tight text-[#14181c]">8. Governing law</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[22px] font-semibold tracking-tight text-[#14181c]">9. Changes to these terms</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-[22px] font-semibold tracking-tight text-[#14181c]">10. Contact</h2>
