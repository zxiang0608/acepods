...
const howItWorks = [
  {
    number: '01',
    title: 'WhatsApp or email us',
    description: 'Tell us your space and what you\'re trying to solve. We\'ll ask a few questions to understand scope.'
  },
  {
    number: '02',
    title: 'You get a full quote',
    description: 'Pod, delivery, and installation — all itemised. No headline price with hidden costs added later.'
  },
  {
    number: '03',
  ...
  },
  {
    ...
    description: 'When the spec and price are right, we lock it in and schedule delivery.'
  },
  {
    number: '05',
...
const mobileNavItems = [
  { label: 'Office Pods', to: '/office-pods' },
...
export default function Demo2Page({ mobilePodMenu = false }) {
  ...
  return (
    <div className="min-h-screen bg-[#f5f3ef] text-[#172126]" style={{ fontFamily: '"Instrument Sans", ui-sans-serif, system-ui, sans-serif' }}>
      ...
      {/* Mobile nav drawer */}
      <div className={`fixed inset-0 z-[100] flex h-[100dvh] flex-col transform overflow-hidden bg-white transition-transform duration-500 ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="flex items-center justify-between border-b border-gray-100 p-6">
          <img src={acePodsLogo} alt="Ace Pods" width="32" height="32" className="h-8 w-auto" />
          <button type="button" onClick={() => setIsMenuOpen(false)} aria-label="Close menu" className="p-2">
            <X size={28} />
          </button>
        </div>
        <div className="flex min-h-0 flex-1 flex-col overflow-y-auto overscroll-contain p-8 pb-14 [-webkit-overflow-scrolling:touch]">
          ...
          <div className="mt-10 space-y-3 border-t border-[#e9e7e1] pt-8">
            ...
            <a
              ...
              onClick={() => setIsMenuOpen(false)}
              className="flex w-full items-center justify-center bg-[#00855a] px-6 py-4 text-[16px] font-semibold text-white transition-colors hover:bg-[#006e4a]"
            >
              Visit the Showroom
            </a>
          </div>
      ...
      <header className="border-b border-[#d9d6ce] bg-[#fbfaf7] px-6 md:px-12">
        <div className="mx-auto flex h-[64px] max-w-[1440px] items-center justify-between md:h-[74px]">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link to="/contact" className="hidden bg-[#00855a] px-3.5 py-2 text-[11px] font-semibold text-white transition-colors hover:bg-[#006e4a] lg:inline-flex md:px-5 md:py-2.5 md:text-[14px]">
              Contact us
            </Link>
            <button
              type="button"
            ...
            {demoProducts.map((product) => (
              ...
              >
                ...
                <div className="mt-5 border-t border-[#d9d5ce] pt-3.5 md:mt-7">
                  ...
                  {product.basePrice && <PodPrice myrAmount={product.basePrice} className="mt-4 block text-[13px] font-semibold text-[#007653]" />}
                </div>
              </Link>
            ))}
          </div>
      ...
      <section className="bg-white px-6 py-[4.5rem] md:px-12 md:py-28">
        <div className="mx-auto max-w-[1280px]">
          <div className="max-w-[660px]">
            ...
            <p className="mt-5 max-w-[56ch] text-[17px] leading-[1.58] text-[#53605d] [text-wrap:pretty] md:text-[18px]">A more practical way to create quiet, usable office space for calls, focus, and meetings.</p>
          </div>
      ...
      <section className="bg-[#e9e7e1] px-6 py-[4.5rem] md:px-12 md:py-28">
        <div className="mx-auto max-w-[1280px]">
          <div className="max-w-[720px]">
            ...
            <p className="mt-5 text-[17px] leading-[1.58] text-[#53605d] [text-wrap:pretty]">The everyday friction is small enough to be ignored — until it starts to affect how well people work.</p>
          </div>
      ...
      <section className="bg-white px-6 py-[4.5rem] md:px-12 md:py-28">
        <div className="mx-auto max-w-[1280px]">
          <div className="max-w-[560px]">
            <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-[#68726f]">How it works</p>
            <h2 className="mt-3 text-[35px] font-semibold leading-[1.02] tracking-[-0.045em] text-[#172126] md:text-[46px]">From first message to installed pod.</h2>
          </div>
          <div className="mt-12 border-t border-[#d8d4cc]">
            {howItWorks.map((step) => (
              <div key={step.number} className="grid grid-cols-[40px_1fr] gap-5 border-b border-[#d8d4cc] py-7 md:grid-cols-[80px_1fr_2fr] md:gap-10 md:py-8">
                <span className="pt-0.5 text-[13px] font-semibold tracking-[0.08em] text-[#007653]">{step.number}</span>
                <div className="md:contents">
                  <h3 className="text-[18px] font-semibold leading-[1.25] tracking-[-0.02em] text-[#172126] md:text-[19px]">{step.title}</h3>
                  <p className="mt-2 text-[15px] leading-[1.62] text-[#59635f] md:mt-0">{step.description}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="mx-auto flex max-w-[1280px] flex-col gap-8 border-y border-white/15 py-8 md:flex-row md:items-end md:justify-between md:py-10">
          <div className="flex max-w-[760px] gap-5 md:gap-7">
            ...
            <div>
              ...
              <h2 className="mt-3 text-[31px] font-semibold leading-[1.04] tracking-[-0.04em] md:text-[38px]">Moving office?<br />Your Ace Pod can move with you.</h2>
              <p className="mt-4 max-w-[62ch] text-[16px] leading-[1.58] text-white/70 [text-wrap:pretty]">We assess, dismantle, transport, reinstall, and inspect your booth — ready to use at its next home.</p>
            </div>
          </div>
      ...
      <section className="bg-[#f7f6f2] px-6 py-[4.5rem] md:px-12 md:py-24">
        <div className="mx-auto max-w-[1000px]">
          <div className="max-w-[670px]">
            ...
            <h2 className="mt-3 text-[35px] font-semibold leading-[1.02] tracking-[-0.045em] text-[#172126] [text-wrap:balance] md:text-[46px]">What buyers usually want to clarify.</h2>
          </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform hover:scale-110 focus:outline-none md:bottom-8 md:right-8"
      >
