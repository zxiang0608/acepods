...
const localFaqItems = [
  ...
  },
  {
    ...
    answer:
      'Ace Office Pods start from RM8,850 for the Ace Uno pod only. Final project pricing depends on the model, quantity, delivery location, installation access, add-ons, and selected configuration.'
  }
];
