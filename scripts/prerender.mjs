...
const STATIC_PRERENDER_META = {
  ...
  '/office-pods': {
    ...
    body: [
      ...
      '- Ace Flex Duo — 2 people, one-to-one discussions, 27 dB noise reduction, from RM21,500',
  ...
  '/compare-office-pods': {
    ...
    body: [
      ...
      '- Ace Flex Duo — 2 pax, 1600 × 1200 mm, from RM21,500 — best for one-to-one discussions',
  ...
  '/locations/penang': {
    ...
    body: [
      ...
      'All six Ace Office Pod models are available — Ace Uno (pod only from RM8,800), Ace Plus (from RM14,500), Ace Flex (from RM19,900), Ace Flex Duo (from RM21,500), Ace Meet (from RM22,200), and Ace Hub (from RM27,800).',
      '## Delivery and installation planning',
